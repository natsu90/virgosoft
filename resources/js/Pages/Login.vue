...
<div class="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
  <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm rounded-xl border border-gray-200 py-8 px-6 max-w-90 w-full">
    ...
    <h3 class="mb-6 text-center text-xl font-bold text-gray-800">Login</h3>
    ...
    <form @submit.prevent="submit">
        ...
        <button @click="submit" class="w-full rounded-lg bg-blue-500 px-4 py-2 font-medium text-white transition duration-300 hover:bg-blue-600">Sign In</button>

        <div class="mt-4 text-center">
            <a href="/register" class="text-sm text-blue-500 hover:text-blue-600">Create an Account</a>
        </div>
    </form>
  </div>
</div>
